...
public class LayoutPresetPersistence {
    ...
    private Map<String, List<LayoutPresetPersistence.Preset>> presets = new HashMap<String, List<LayoutPresetPersistence.Preset>>();

    public LayoutPresetPersistence() {
        loadPresets();
    }

    public void savePreset(String name, EdgeLayout layout) {
        LayoutPresetPersistence.Preset preset = addPreset(new LayoutPresetPersistence.Preset(name, layout));
    ...
    public void loadPreset(LayoutPresetPersistence.Preset preset, EdgeLayout layout) {
    ...
    public List<LayoutPresetPersistence.Preset> getPresets(EdgeLayout layout) {
            ...
            for (FileObject child : folder.getChildren()) {
                if (child.isValid() && child.hasExt("xml")) {
                    try {
                        ...
                        LayoutPresetPersistence.Preset preset = new LayoutPresetPersistence.Preset(document);
                        addPreset(preset);
                    } catch (Exception ex) {
                        ex.printStackTrace();
                    }
    ...
    private LayoutPresetPersistence.Preset addPreset(LayoutPresetPersistence.Preset preset) {
        List<LayoutPresetPersistence.Preset> layoutPresets = presets.get(preset.layoutClassName);
        if (layoutPresets == null) {
            layoutPresets = new ArrayList<LayoutPresetPersistence.Preset>();
            presets.put(preset.layoutClassName, layoutPresets);
        }
        for (LayoutPresetPersistence.Preset p : layoutPresets) {
            if (p.equals(preset)) {
                return p;
            }
        }
    ...
    protected static class Preset {
        ...
        private Preset(String name, EdgeLayout layout) {
            this.name = name;
        ...
        public boolean equals(Object obj) {
            ...
            final LayoutPresetPersistence.Preset other = (LayoutPresetPersistence.Preset) obj;
