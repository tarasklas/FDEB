 ...
 * user interface. There is one model per {@link Workspace} <p>
...
public interface EdgeLayoutModel {
     ...
     * <code>layoutBuilder</code>. If saved properties exists, the layout
     * properties values are set. Values are default if it is the first time
     * this layout is built. <p> Use this method instead of
     * <code>LayoutBuilder.buildLayout()</code> directly.
     *
     * @param layoutBuilder the layout builder
     * @return the layout build from
     * <code>layoutBuilder</code> with formely saved properties.
     */
    ...
    /**
     * Returns
     * <code>true</code> if a layout is currently running,
     * <code>false</code> otherwise.
     */
    public boolean isRunning();

    /**
     * Add a property change listener for this model. The
     * <code>listener</code> is notified when layout is selected and when
     * running flag change.
     *
