 ...
 * instance. <p> Preview properties are created by renderers to let users
 * configure how items should be rendered. Each property should have a unique
 * name and a type. Users should use the static
 * <code>createProperty()</code> methods to create instances. <p> Static default
 * property names are defined in this class to help renderers to reuse external
 * properties and have cleaner code. <P> Properties can be grouped by
 * categories, which default are
...
public class PreviewProperty {
    ...
    /**
     * General
     * <code>Boolean</code> property which indicates wheter the graph is
     * directed
     */
    public static final String DIRECTED = "directed";
    /**
     * General
     * <code>Color</code> property of the background color
     */
    public static final String BACKGROUND_COLOR = "background-color";
    /**
     * General
     * <code>Float</code> property which indicates the ratio of the visible
     * graph used in preview. For instance if 0.5 only 50% of nodes items are
     * built.
     */
    public static final String VISIBILITY_RATIO = "visibility-ratio";
    /**
     * General
     * <code>Float</code> property in percentage (0-100) describing the margin
     * size. For instance if the value is 4 the size of the margin is 4% of the
     * total graph width.
     */
    ...
    /**
     * Node
     * <code>Float</code> property defining the node border size.
     */
    public static final String NODE_BORDER_WIDTH = "node.border.width";
    /**
     * Node
     * <code>DependantColor</code> property which defines the border color. A
    ...
    /**
     * Node
     * <code>Float</code> property between 0-100 which defines the opacity. 100
     * means opaque.
     */
    ...
    /**
     * Edge
     * <code>Boolean</code> property defining whether to show edges.
     */
    public static final String SHOW_EDGES = "edge.show";
    /**
     * Edge
     * <code>Float</code> property for the edge's thickness
     */
    public static final String EDGE_THICKNESS = "edge.thickness";
    /**
     * Edge
     * <code>Boolean</code> property whether to draw curved edges. A
     * <code>false</code> value means straight edges.
     */
    public static final String EDGE_CURVED = "edge.curved";
    /**
     * Edge
     * <code>EdgeColor</code> property defining the edge color. It could be the
     * source's color, the target's color, a mixed color, the edge's original
    ...
    /**
     * Edge
     * <code>Boolean</code> property defining whether edge's weight should be
     * rescaled between fixed bounds.
     */
    public static final String EDGE_RESCALE_WEIGHT = "edge.rescale-weight";
    /**
     * Edge
     * <code>Float</code> property defining an extra distance between the node
     * and the edge.
     */
    ...
    /**
     * Arrow
     * <code>Float</code> property defining the arrow size.
     */
    public static final String ARROW_SIZE = "arrow.size";
    //Constants node labels
    /**
     * Node Label
     * <code>Boolean</code> property defining whether to show node labels.
     */
    public static final String SHOW_NODE_LABELS = "node.label.show";
    /**
     * Node Label
     * <code>Font</code> property defining node label's font.
     */
    public static final String NODE_LABEL_FONT = "node.label.font";
    /**
     * Node Label
     * <code>Boolean></code> property defining whether to use node's size in
     * label size calculation.
     */
    public static final String NODE_LABEL_PROPORTIONAL_SIZE = "node.label.proportinalSize";
    /**
     * Node Label
     * <code>DependantOriginalColor</code> property defining the color label.
     * The color could either be the node's color, the label original color if
     * it has any or a custom color.
     */
    public static final String NODE_LABEL_COLOR = "node.label.color";
    /**
     * Node Label
     * <code>Boolean</code> property defining whether the label is shortened.
     */
    public static final String NODE_LABEL_SHORTEN = "node.label.shorten";
    /**
     * Node Label
     * <code>Integer</code> property defining the maximum number of characters.
     */
    public static final String NODE_LABEL_MAX_CHAR = "node.label.max-char";
    /**
     * Node Label Outline
     * <code>Float</code> property defining the outline size.
     */
    ...
    /**
     * Node Label Outline
     * <code>DependantColor</code> property defining the outline color. The
     * color can be the node's color or a custom color.
     */
    ...
    /**
     * Edge Label
     * <code>Boolean</code> property defining whether to show edge labels.
     */
    public static final String SHOW_EDGE_LABELS = "edge.label.show";
    /**
     * Edge Label
     * <code>Font</code> property defining edge label's font.
     */
    public static final String EDGE_LABEL_FONT = "edge.label.font";
    /**
     * Edge Label
     * <code>DependantOriginalColor</code> property defining the color label.
     * The color could either be the edge's color, the label original color if
     * it has any or a custom color.
     */
     ...
     * Edge Label Outline
     * <code>DependantColor</code> property defining the outline color. The
     * color can be the edge's color or a custom color.
     */
    public static final String EDGE_LABEL_OUTLINE_COLOR = "edge.label.outline.color";
    //Constants UI helps
    /**
     * General
     * <code>Boolean</code> property set as
     * <code>true</code> when the user is panning the canvas. Helps to
    ...
    /*
     * Edge Layout category
     */
    public static final String CATEGORY_EDGE_LAYOUT = "Edge Layout";
    //Variables
    final String name;
    ...
    /**
     * Create a new preview property. The
    ...
    /**
     * Create a new preview property. The
     * <code>name</code> should be unique. If the type is different from basic
     * types (Integer, Float, Double, String, Boolean or Color) make sure to
     * implement a {@link PropertyEditor} and register it:
     ...
     * <li>PreviewProperty.CATEGORY_NODE_LABELS</li>
     * <li>PreviewProperty.CATEGORY_EDGE_LABELS</li>
     * <li>PreviewProperty.CATEGORY_EDGE_ARROWS</li></ul> The
     * <code>dependantProperties</code> list is used to automatically disable
     * the property if the dependant property is not selected. The dependant
     ...
     *
     * @return this property's display name or
     * <code>null</code>
     */
     ...
     * <code>null</code> if not set.
     *
     * @return this property's description or
     * <code>null</code>
     */
     ...
     * <code>null</code> if not set.
     *
     * @return this property's category or
     * <code>null</code>
     */
